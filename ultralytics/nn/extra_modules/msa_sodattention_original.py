...
__all__ = ("MSAOriginalSODAttention",)
...
class MSAOriginalSODAttention(nn.Module):
    """Paper-structure SODAttention from MSA-DETR.

    The module follows the paper diagram: grouped features are processed by a
    GLM branch and a ContextBlock branch, then added and projected.
    """
